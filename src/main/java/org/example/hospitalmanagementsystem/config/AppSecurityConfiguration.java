...
import org.example.hospitalmanagementsystem.services.impl.AppUserDetailsService;

@Configuration
public class AppSecurityConfiguration {
    private final UserRepo userRepository;

    public AppSecurityConfiguration(UserRepo userRepository) {
                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests ->
                                authorizeHttpRequests.
                                        ...
                                        .permitAll().
                                        requestMatchers("/account").hasAnyRole(UserRoles.USER.name()).
                                        requestMatchers("/doctor/**").hasAnyRole(UserRoles.DOCTOR.name()).
